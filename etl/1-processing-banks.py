...
# lendo arquivos
bank_df = spark.read.csv('dbfs:/pece-poli-de/bronze/banks/', header=True, sep='\t')
...
bank_df.write.mode("overwrite").csv("dbfs:/pece-poli-de/silver/banks/", header=True, sep=";")
...
csv_file_path = get_data_file_path('dbfs:/pece-poli-de/silver/banks/')
...
#html_file_content = open('/dbfs/great_expectations/uncommitted/data_docs/local_site/index.html', 'r').read()
